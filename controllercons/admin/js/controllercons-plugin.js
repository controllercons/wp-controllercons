	...
	tinymce.PluginManager.add('controllercons', function(editor) {
		...
		function getControllercons() {
			return [
				...
				['󌀠', 'wii-remote', 'Wii Remote'],
				['󌀡', 'wii-remote-o', 'Wii Remote Outlined'],
				['󌀢', 'wiiu', 'Wii U'],
				...
				['󌀨', 'switch-joycon-l', 'Switch Joy Con (L)'],
				['󌀩', 'switch-joycon-l-o', 'Switch Joy Con (L) Outlined'],
				['󌀰', 'switch-joycon-r', 'Switch Joy Con (R)'],
				['󌀱', 'switch-joycon-r-o', 'Switch Joy Con (R) Outlined'],
				['󌀲', 'switch', 'Switch'],
				['󌀳', 'switch-o', 'Switch Outlined'],
			];
		}
